...
# Parameters for Case 7
m, n = 2, 3
c = np.array([500, 400])  # Capacities
p = np.array([
    [8, 7, 9],   # Milk Powder
    [6, 10, 11]  # Cheese Blocks
])  # Profit per unit
demand_means = np.array([125, 100, 225])  # Mean demands
demand_stds = np.array([25, 20, 30])      # Standard deviations of demands
K = 2  # Maximum number of arcs
