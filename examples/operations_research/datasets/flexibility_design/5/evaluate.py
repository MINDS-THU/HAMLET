...
m, n = 2, 4
c = np.array([400, 500])  # Capacities
p = np.array([
    [50, 40, 45, 42],  # Chemical A
    [30, 35, 25, 20]   # Chemical B
])  # Profit per unit
demand_means = np.array([150, 250, 115, 75])  # Mean demands
demand_stds = np.array([25, 40, 20, 15])      # Standard deviations of demands
K = 3  # Maximum number of arcs
