...
# Parameters for Case 8
m, n = 3, 4
c = np.array([600, 400, 300])  # Capacities
p = np.array([
    [15, 14, 12, 10],  # Steel Rods
    [20, 18, 16, 15],  # Aluminum Plates
    [10, 12, 8, 9]     # Copper Wiring
])  # Profit per unit
demand_means = np.array([300, 200, 250, 150])  # Mean demands
demand_stds = np.array([50, 40, 60, 30])       # Standard deviations of demands
K = 5  # Maximum number of arcs
