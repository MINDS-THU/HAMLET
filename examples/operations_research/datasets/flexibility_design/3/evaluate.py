...
m, n = 2, 3
c = np.array([200, 300])  # Capacities
p = np.array([
    [15, 14, 10],  # Men’s Jackets
    [12, 15, 9]    # Women’s Jackets
])  # Profit per unit
demand_means = np.array([150, 120, 75])  # Mean demands
demand_stds = np.array([25, 20, 15])     # Standard deviations of demands
