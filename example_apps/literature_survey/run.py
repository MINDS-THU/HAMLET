...
def create_literature_survey_agent(model_id="gpt-4.1", save_dir="example_apps/literature_survey/report"):
...
if __name__ == "__main__":
    ...
    base_temp_dir = "example_apps/literature_survey/reports"
