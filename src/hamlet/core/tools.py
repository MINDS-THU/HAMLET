...
class FinalAnswerTool(Tool):
    """A simple tool used by agents to signal the final answer.

    Moved from utils.py to tools.py to avoid circular imports (utils -> tools -> agent_types -> utils).
    """
    ...
    def forward(self, answer: Any) -> Any:  # type: ignore[override]
        return answer
