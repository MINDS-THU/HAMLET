...
class LiteLLMModel(ApiModel):
    ...
    def create_client(self):
        ...
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'litellm' extra to use LiteLLMModel: `pip install 'hamlet[litellm]'`"
            ) from e
...
class LiteLLMRouterModel(LiteLLMModel):
    ...
    def create_client(self):
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'litellm' extra to use LiteLLMRouterModel: `pip install 'hamlet[litellm]'`"
            ) from e
